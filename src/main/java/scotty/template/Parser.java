...
public final class Parser {
    ...
    public static void parse(String sourceName, final InputStream inputStream, final OutputStream outputStream, final Database database,
        ...
        try {
            ...
            LOGGER.severe("Unable to export database, context or output.");
            throw evalError;
        }
        ...
        while (true) {
            ...
            switch (operator) {
                ...
                case IMPORT:
                    ...
                    parse(fileName, Utilities.getResourceAsStream(fileName), outputStream, database, importContext);
                    break;
                case TYPES:
                ...
                case '\r':
                    try {
                        ...
                        LOGGER.severe((sourceName == null ? "Unknown" : sourceName) + ": [" + evalError.getErrorLineNumber() + "] " + evalError.getMessage());
                        throw evalError;
                    }
                    break;
